  ...
  return (
    <section className="bg-surface-alt">
      <div className="w-full px-0 sm:px-8 lg:px-12">
        <div className="rounded-none border-y border-[rgba(10,26,47,.08)] bg-surface-alt px-4 py-12 shadow-[0_24px_60px_-25px_rgba(5,14,26,.15)] sm:px-10 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-12 text-center">
            <h2 className="pb-4 font-nacelle text-3xl font-semibold text-brand-primary md:text-4xl">
              Testimonios que nos impulsan
            </h2>
            <p className="text-lg text-brand-primary opacity-80">
              Líderes y equipos que confían en Ariwa Labs para llevar sus proyectos tecnológicos al siguiente nivel.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center pb-8 md:pb-16">
              <div className="relative inline-flex w-full max-w-5xl flex-nowrap gap-2 overflow-x-auto rounded-[1.25rem] bg-white/70 p-1 shadow-[0_12px_30px_-18px_rgba(10,26,47,.3)] backdrop-blur-sm no-scrollbar md:flex-wrap md:justify-center">
                {/* Button #1 */}
                <button
                  className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-rose-200 ${category === 1 ? "bg-brand-primary text-gray-50 shadow-[0_12px_30px_-18px_rgba(10,26,47,.8)]" : "text-brand-primary opacity-70 hover:bg-[rgba(10,26,47,.08)] hover:opacity-100"}`}
                  aria-pressed={category === 1}
                  onClick={() => setCategory(1)}
                >
                  <svg
                    className={`fill-current ${category === 1 ? "text-brand-accent" : "text-brand-primary opacity-60"}`}
                ...
                {/* Button #2 */}
                <button
                  className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-rose-200 ${category === 2 ? "bg-brand-primary text-gray-50 shadow-[0_12px_30px_-18px_rgba(10,26,47,.8)]" : "text-brand-primary opacity-70 hover:bg-[rgba(10,26,47,.08)] hover:opacity-100"}`}
                  aria-pressed={category === 2}
                  onClick={() => setCategory(2)}
                >
                  <svg
                    className={`fill-current ${category === 2 ? "text-brand-accent" : "text-brand-primary opacity-60"}`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height={16}
                  >
                ...
                {/* Button #3 */}
                <button
                  className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-rose-200 ${category === 3 ? "bg-brand-primary text-gray-50 shadow-[0_12px_30px_-18px_rgba(10,26,47,.8)]" : "text-brand-primary opacity-70 hover:bg-[rgba(10,26,47,.08)] hover:opacity-100"}`}
                  aria-pressed={category === 3}
                  onClick={() => setCategory(3)}
                >
                  <svg
                    className={`fill-current ${category === 3 ? "text-brand-accent" : "text-brand-primary opacity-60"}`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height={16}
                  >
                ...
                {/* Button #4 */}
                <button
                  className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-rose-200 ${category === 4 ? "bg-brand-primary text-gray-50 shadow-[0_12px_30px_-18px_rgba(10,26,47,.8)]" : "text-brand-primary opacity-70 hover:bg-[rgba(10,26,47,.08)] hover:opacity-100"}`}
                  aria-pressed={category === 4}
                  onClick={() => setCategory(4)}
                >
                  <svg
                    className={`fill-current ${category === 4 ? "text-brand-accent" : "text-brand-primary opacity-60"}`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height={16}
                  >
                ...
                {/* Button #5 */}
                <button
                  className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-rose-200 ${category === 5 ? "bg-brand-primary text-gray-50 shadow-[0_12px_30px_-18px_rgba(10,26,47,.8)]" : "text-brand-primary opacity-70 hover:bg-[rgba(10,26,47,.08)] hover:opacity-100"}`}
                  aria-pressed={category === 5}
                  onClick={() => setCategory(5)}
                >
                  <svg
                    className={`fill-current ${category === 5 ? "text-brand-accent" : "text-brand-primary opacity-60"}`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height={16}
                  >
...
export function Testimonial({
  ...
  return (
    <article
      className={`relative rounded-2xl border border-[rgba(10,26,47,.08)] bg-white/95 p-6 shadow-[0_20px_45px_-25px_rgba(10,26,47,.25)] transition-opacity ${!testimonial.categories.includes(category) ? "opacity-30" : ""}`}
    >
      <div className="flex flex-col gap-4">
        <div>
          <Image src={testimonial.clientImg} height={36} alt="Client logo" />
        </div>
        <p className="text-brand-primary before:content-['“'] after:content-['”']">
          {children}
        </p>
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-medium text-brand-primary">
            ...
            <a
              className="text-brand-accent transition-colors hover:text-rose-400"
              href="#0"
            >
              {testimonial.company}
            </a>
